...
// import { MobileLinks, MobileMenu } from './nav/MobileMenu';
...
const Navbar = () => {
  return (
    <>  
      ...
      <nav className="nav bg-black z-40">
...
const InitialNavbar = () => {
  ...
  return (
    <nav className='bg-black  absolute top-0 w-full border-b border-blue-500'>
          ...
          {session && (
            <div className='absolute inset-y-0 right-0 flex items-center pr-2 md:static md:inset-auto md:ml-6 md:pr-0'>
              <Link href='/messages' className='relative group '>
                <button  id="CART-FROM-NABAR_COMP"
                  type='button'
