   ...
   <Popover className="relative isolate z-50 shadow">
      <div className="bg-white py-0">
        <div className="mx-auto max-w-7xl px-6 lg:pr-0">
          <Popover.Button className="inline-flex items-center gap-x-1 header__primary__button">
           <span> {resources.name}</span>
            <ChevronDownIcon className="h-5 w-5 arrow-spin" aria-hidden="true" />
          </Popover.Button>
        </div>
      </div>
    ...
    <Transition id={resources.name}
      ...
      >
       ...
       <Popover.Panel id={resources.name}   
        as={Fragment} className="absolute inset-x-50 top-0 -z-10 bg-white pt-16 shadow-lg ring-1 ring-gray-900/5  w-screen left-[-63vw] ml-4 pl-16">
