    ...
    <>
      <div className="bg-black py-14 sm:py-22 overflow-hidden">
        <div className="max-w-8xl mx-auto md:px-6 lg:px-8">
          ...
          <section className="black-2-bg max-w-10xl py-4 sm:py-10 border-top border-1 border-gray-100 sm:p-4">
         <div className="grid grid-cols-3">
          <div className="utils_mobileOnly__pEh2w">
            ...
            className="responsive-image loaded blocks__item__image blocks__item__image--news-size-3" data-geist-avatar="" data-version="v1" role="img" style={{ "--size": "60px" }}>
              <img data-version="v1" alt="" title="" loading="eager" width="60" height="60" decoding="async" data-nimg="1" className="responsive-image loaded max-h-[60vh] !w-[30vw] !aspect-[3/5]" 
          ...
          <div className="reviews">
            ...
            <div className="lg:px-4 group-text-change">
              <div className="e flex pl-2 inline-flex overflow-x-auto flex pt-4  max-w-7xl lg:mx-0 lg:max-w-none lg:grid-cols-2 xl:grid-cols-3 sm:space-x-4 w-full pb-8">
                {featuredReviews.map((review, index) => (
                  <div  key={index} className="testimonial  xl:!max-w-[28vw] relative !z-10 group  max-h-[20em] flex-none px-6 mr-2 mb-6 hover:ring-1 hover:ring-gray-500 mb-12  transition-transform rounded-lg flex-col pb-10 sm:pb-16 lg:pb-0 lg:pr-8 xl:pr-20 sm:px-4 xl:px-6 max-w-xs sm:max-w-lg xl:max-w-xl">
                    <figure className="reviewer-cred-text mt-10 flex flex-auto flex-col justify-between">
                      <blockquote className="text-lg leading-8  max-h-[12em] pb-4 sm:pb-8">
                        <p className="text-gray-300/90 group-hover:text-white  opacity-1 z-20 text-ellipsis overflow-hidden">
                          {review.text}
                        </p>
                      </blockquote>
                      <div className='absolute bottom-[-4em] inset-x-0 mx-[2em] flex-none !z-50 group-hover:shadow-xl xl:max-w-[30vw]'> 
                      <figcaption id="fillChild" className={`sm:mt-10 flex items-center gap-x-6 group-hover:bg-white rounded-r-md rounded-l-full  ${hoveredIndex === index ? 'bg-white' : 'bg-[transparent]'}`}>
                        <figure className="rounded-full p-2">
                        ...
                        <div className="text-base hover:text-black py-2">
